...
<main>
    <section class="show__main container">
        <a class="btn-primary" href="{{ route('posts.index') }}"> Back</a>
    </section>
    <section class="ads container">
        ...
        <form action="{{ route('posts.update', $post->id) }} " method="POST">
            ...
            <div class="ads__inp">
                ...
                <p class="ads__text">Продать</p>
                <select name="buy" id=""  value="{{ $post->buy }}" class="typeBuildings size" >
            ...
            <div class="ads__inp">
                ...
                <select name="type" id=""  value="{{ $post->type}}" class="type size">
            ...
            <div class="ads__inp">
                ...
                <input type="number" value="{{ $post->price }}" name="price" placeholder="Цена" class="size">
            </div>
            <div class="ads__inp">
                <p class="ads__text">Тип строения</p>
                <select name="typeBuildings" id="" class="typeBuildings size" value="{{ $post->typeBuilding}}" >
                    <option value="кирпичный">кирпичный</option>
                    <option value="панельный">панельный</option>
                    <option value="монолитныйг">монолитный</option>
                    <option value="иное">иное</option>
                </select>
            </div>
            <div class="ads__inp">
                <p class="ads__text">Год постройки (сдачи в эксплуатацию)</p>
                <input type="number" name="year" value="{{ $post->year }}" placeholder="Год" class="size">
            </div>
            <div class="ads__inp">
                <p class="ads__text">Этаж</p>
                <input type="number" name="storey" value="{{ $post->storey }}" placeholder="Этаж" class="size">
            </div>
            <div class="ads__inp">
                <p class="ads__text">Этажей дома</p>
                <input type="number" name="storey_home" value="{{ $post->storey_home }}" placeholder="Этаж дома" class="size">
            </div>
            <div class="ads__inp">
                <p class="ads__text">Площадь, м²</p>
                <input type="number" name="square" value="{{ $post->square }}" placeholder="Площадь" class="size">
            </div>
            <div class="ads__inp">
                <p class="ads__text">Площадь кухни, м²</p>
                <input type="number" name="kitchen_area" value="{{ $post->kitchen_area }}" placeholder="Площадь кухни" class="size">
            </div>
            <div class="ads__inp">
                <p class="ads__text">Количество комнаты</p>
                <input type="number" name="rooms" value="{{ $post->rooms }}"  placeholder="количество комнаты" class="size">
            </div>
            <div class="ads__inp">
                <p class="ads__text">Расположение</p>
                <select id="cities" name="city" class="size" value="{{ $post->city }}">
            ...
            <div class="ads__inp">
                ...
                <input type="text" name="address" value="{{ $post->address }}" placeholder="Улица или микрорайон" class="size">
            </div>
            <div class="ads__inp">
                <p class="ads__text">Телефоны</p>
                <input type="number" name="number" value="{{ $post->number }}" placeholder="Телефоны" class="size">
            </div>
            <div class="ads__inp">
                <p class="ads__text">Загаловок</p>
                <input type="text" name="title" value="{{ $post->title }}" placeholder="Загаловок" class="size">
            </div>
            <div class="ads__inp">
                <p class="ads__text">Текст объявления</p>
                <textarea name="description" placeholder="Текст объявления" class="size__desc">{{ $post->description }}</textarea>
            </div>
